    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->_tpl_vars['Captions']->GetMessageString('RenameUser'); ?>
</h4>
            </div>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "page-header.tpl", 'smarty_include_vars' => array('pageTitle' => $this->_tpl_vars['Captions']->GetMessageString('AdministrationPanel'))));
...
<?php echo '</span>
                ...
                <button class="btn btn-default" title="Rename user"
                    ...
                    <i class="icon-edit"></i>
                    '; ?>
<span class="hidden-xs"><?php echo $this->_tpl_vars['Captions']->GetMessageString('Rename'); ?>
</span><?php echo '
                </button>
